...
vital_features = ["heart_rate_mean", "heart_rate_max", "sbp_mean", "sbp_min", "sbp_max", "dbp_mean", "dbp_min", "dbp_max", "temperature_mean", "temperature_min"]
electrolyte_features = ["potassium_mean", "sodium_mean"]
blood_count_features = ["platelets_mean", "haemoglobin_mean", "wbc_mean", "rbc_mean"]
gcs_features = ["gcs_min"]
age_features = ["anchor_age"]
